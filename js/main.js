...
const displayResult = (result) => {
    ...
    let finishResult = document.querySelector('.finishResult')


    if(Math.round(result.main.temp) > 10){
      finishResult.innerText = "Havanin temperaturu ekincilik ucun yararlidir.Bu seherde ekincilikle mesgul ola bilersiniz.";
      finishResult.style.color = "green";
    }else{
      finishResult.innerText = "Havanin temperaturu ekincilik ucun yararsizdir.Bu seherde ekincilikle mesgul ola bilmersiniz.";
      finishResult.style.color = "red";
    }
